...
export const ACCOUNTING_FIELDS: Field[] = [
  // ----- Job Header -----
  { key: "acc_job_status", label: "ACC Job Status", group: "Job Header", type: "dropdown", list: "im_ops_status", mandatory: true, sticky: true, width: 130, help: "แก้หลัง End ต้องติดต่อ Supervisor" },
  { key: "acc_pic", label: "Acc PIC", group: "Job Header", type: "dropdown", list: "acc_pic", mandatory: true, sticky: true, width: 120 },
  ...
  { key: "job_no", label: "Job No. (IMP/EXP)", group: "Job Header", type: "auto", width: 130, help: "ตัวเชื่อมกับ CS (สร้างอัตโนมัติ)" },
  ...
  { key: "customer", label: "Customer (IMP/EXP)", group: "Job Header", type: "auto", width: 160, pull: { imp: "customer", exp: "customer" } },
  ...
  { key: "ap_status", label: "AP Status", group: "Accounts Payable (AP)", type: "dropdown", list: "ap_status", mandatory: true, width: 150 },
  ...
  { key: "ar_status", label: "AR Status", group: "Accounts Receivable (AR)", type: "dropdown", list: "ar_status", mandatory: true, width: 150 },

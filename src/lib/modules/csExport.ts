...
export const EXPORT_FIELDS: Field[] = [
  ...
  { key: "exp_job_no", label: "EXP/Job No.", group: "OPS", type: "text", mandatory: true, sticky: true, width: 130 },
  ...
  // ----- Documentation -----
  { key: "ex_doc", label: "EX/DOC", group: "Documentation", type: "dropdown", list: "ex_doc", width: 110 },

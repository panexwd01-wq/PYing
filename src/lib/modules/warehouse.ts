...
export const WAREHOUSE_FIELDS: Field[] = [
  ...
  // ----- Extra Service -----
  { key: "extra_require", label: "(WHA) Extra/Service Require", group: "Extra Service", type: "toggle", mandatory: true, width: 150 },
  ...
  { key: "wh_actual_rcv", label: "ACTUAL RCV CARGO TOTAL", group: "Warehouse Operation", type: "text", mandatory: true, width: 170 },
  { key: "wh_supp1_sts", label: "WH Supp 1 Sts", group: "Warehouse Operation", type: "dropdown", list: "supplier_status", mandatory: true, width: 120 },
  { key: "wh_supp1_end", label: "WH Supp 1 End Date", group: "Warehouse Operation", type: "auto", width: 150, help: "Auto เมื่อ WH Supp 1 Sts = End" },
  { key: "wh_supp1_kpi", label: "WH Supp 1 KPI", group: "Warehouse Operation", type: "dropdown", list: "kpi", width: 120 },
  { key: "wh_supp1_pending", label: "WH Supp 1 Pending Reason", group: "Warehouse Operation", type: "text", mandatory: true, width: 160 },

  // ----- Closing Information -----
  { key: "actual_finished_date", label: "Actual Finished Date", group: "Closing Information", type: "datetime", mandatory: true, width: 160 },

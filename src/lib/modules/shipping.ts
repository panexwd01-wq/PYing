...
// ===== 06_Shipping — ปลายทาง: ดึงหัว Job จาก CS Import/Export ด้วย Job No. =====
export const SHIPPING_FIELDS: Field[] = [
  // ----- Job Info -----
  { key: "shipp_status", label: "SHIPP Status", group: "Job Info", type: "dropdown", list: "im_ops_status", mandatory: true, sticky: true, width: 130 },
  { key: "job_type", label: "Job Type", group: "Job Info", type: "auto", sticky: true, width: 130, pull: { imp: "job_type", exp: "job_type" } },
  { key: "job_no", label: "Job No. (IMP/EXP)", group: "Job Info", type: "text", mandatory: true, sticky: true, width: 130, help: "กรอกเลขงาน แล้วกด Refresh เพื่อดึงข้อมูลจาก CS" },
  { key: "entry_pic", label: "Entry PIC", group: "Job Info", type: "dropdown", list: "entry_pic", width: 120 },
  { key: "booking_mbl", label: "Booking / MBL No.", group: "Job Info", type: "auto", width: 160, pull: { imp: "imp_booking_mbl", exp: "exp_booking_mbl" } },
  { key: "hbl", label: "HBL No.", group: "Job Info", type: "auto", width: 140, pull: { imp: "imp_hbl", exp: "exp_hbl" } },
  { key: "customer", label: "Customer", group: "Job Info", type: "auto", width: 160, pull: { imp: "customer", exp: "customer" } },
  { key: "cargo_type", label: "Cargo Type", group: "Job Info", type: "dropdown", list: "cargo_type", width: 130 },
  ...
  // ----- Extra Service -----
  { key: "extra_require", label: "(SHIPP) Extra/Service Require", group: "Extra Service", type: "toggle", width: 150 },
  ...
  // ----- Shipping Execution -----
  { key: "ship_pic", label: "Ship PIC", group: "Shipping Execution", type: "dropdown", list: "ship_pic", width: 130, help: "ถ้าเลือก Outsourcing ต้องเลือก Ship Outsourcing ต่อ" },
  { key: "ship_outsourcing", label: "Ship Outsourcing", group: "Shipping Execution", type: "dropdown", list: "supplier_transport", width: 150 },
  { key: "forgot_ot", label: "Forgot OT", group: "Shipping Execution", type: "toggle", width: 100 },
  { key: "ot_requested", label: "OT Requested", group: "Shipping Execution", type: "toggle", width: 110 },
  { key: "ot_receipt_lost", label: "OT Receipt Lost", group: "Shipping Execution", type: "dropdown", list: "receipt_lost", width: 120 },

  // ----- Clearance Monitoring -----
  { key: "clearance_status", label: "Clearance Status", group: "Clearance Monitoring", type: "dropdown", list: "clearance_status", width: 140 },
  { key: "clearance_pending_reason", label: "Clearance Pending Reason", group: "Clearance Monitoring", type: "text", width: 170 },
  ...
  // ----- Accounting & Closing -----
  { key: "ship_close_acc_status", label: "Ship Close Acc Status", group: "Accounting & Closing", type: "dropdown", list: "complete_sts", width: 150 },

...
const transSupp = (n: number): Field[] => [
  ...
  { key: `trans_supp${n}_time`, label: `Supp ${n} Delivery Time / Note`, group: `Transport Supp ${n}`, type: "text", width: 160, help: "เวลาที่นัดส่ง เช่น 08:00-10:00 หรือโน้ตอื่น ๆ" },
...
export const IMPORT_FIELDS: Field[] = [
  ...
  { key: "imp_job_no", label: "IMP/Job No.", group: "OPS", type: "text", sticky: true, summary: true, width: 130, colorPick: true, help: "กดปุ่มสีข้างช่องเพื่อทำเครื่องหมาย (ความหมายของแต่ละสีตั้งได้ที่หน้าตั้งค่า)" },
  { key: "imp_job_no_color", label: "Job No. Color", group: "OPS", type: "text", hidden: true },
  { key: "customer", label: "Customer", group: "OPS", type: "dropdown", list: "customer", summary: true, width: 150 },
  { key: "eta_imp", label: "ETA (IMP)", group: "OPS", type: "datetime", summary: true, width: 160, dateOnly: true },
  // กลุ่ม 1
  ...
  { key: "imp_booking_mbl", label: "IMP/Booking / MBL No.", group: "OPS", type: "text", width: 170, colorPick: true, help: "กดปุ่มสีข้างช่องเพื่อเลือกสี/เอาสีออก (ความหมายของแต่ละสีตั้งได้ที่หน้าตั้งค่า)" },
  ...
  // กลุ่ม 2
  { key: "etd_imp", label: "ETD (IMP)", group: "OPS", type: "datetime", width: 160, dateOnly: true },
  ...
  { key: "dem_start", label: "DEM Start", group: "OPS", type: "datetime", dateOnly: true, width: 140, help: "วันเริ่มนับ Demurrage" },
  ...
  { key: "total_pkg", label: "Total PKG/Carton/Pallet", group: "Documentation", type: "text", width: 160, help: "พิมพ์ตัวเลขหรือข้อความก็ได้" },
  { key: "total_pkg_unit", label: "หน่วยสินค้า", group: "Documentation", type: "dropdown", list: "pkg_unit", width: 120 },

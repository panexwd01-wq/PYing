...
export const IMPORT_FIELDS: Field[] = [
  // ----- OPS -----
  { key: "im_ops_status", label: "IM/OPS Status", group: "OPS", type: "dropdown", list: "im_ops_status", mandatory: true, sticky: true, width: 130, help: "กด End ต้องผ่านเงื่อนไขครบ · แก้หลัง End ต้องติดต่อ Supervisor" },
  ...
  { key: "imp_job_no", label: "IMP/Job No.", group: "OPS", type: "text", sticky: true, width: 130 },

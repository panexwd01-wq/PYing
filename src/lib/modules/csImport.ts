...
// ===== 04_CS_Import — ตรงตาม requirement.xlsx (คอลัมน์ CS Import) =====
// หมายเหตุ: ช่องสีเทา (auto) ในกลุ่ม Shipping/Transport/Warehouse ดึงย้อนจากโมดูลปลายทางด้วย Job No.
export const IMPORT_FIELDS: Field[] = [
  // ----- OPS -----
  { key: "im_ops_status", label: "IM/OPS Status", group: "OPS", type: "dropdown", list: "im_ops_status", mandatory: true, sticky: true, width: 130, help: "กด End ต้องผ่านเงื่อนไขครบ" },
  { key: "job_type", label: "Job Type", group: "OPS", type: "dropdown", list: "job_type", mandatory: true, sticky: true, width: 140, help: "Re-Export/* จะเชื่อมไป CS Export อัตโนมัติ (กด Sync)" },
  ...
  { key: "cargo_type", label: "Cargo Type", group: "OPS", type: "auto", width: 130, help: "ดึงจาก Shipping", rpull: { from: "06_Shipping", field: "cargo_type" } },
  ...
  { key: "cs_note_ship", label: "Cs Note for Ship Pic", group: "Shipping", type: "text", width: 180, help: "ข้อความถึง Ship PIC (Shipping จะดึงไปแสดง)" },
  ...
  { key: "trans_supp1", label: "Trans Supp 1", group: "Transport", type: "dropdown", list: "supplier_transport", width: 140, help: "เลือก Supp แล้ว Transport จะเห็นว่าต้องใช้เจ้านี้" },
  ...
  { key: "cs_note_wh", label: "Cs Note for WH Pic", group: "Warehouse", type: "text", width: 180 },
